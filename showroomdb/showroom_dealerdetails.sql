...
CREATE TABLE `dealerdetails` (
  ...
  `dgst` varchar(45) NOT NULL,
  `daddress` varchar(45) NOT NULL,
  `dphone` bigint(10) NOT NULL,
  `demail` varchar(45) NOT NULL,
  `craetedat` datetime DEFAULT CURRENT_TIMESTAMP,
  `updatedat` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `dgst_UNIQUE` (`dgst`),
  UNIQUE KEY `dphone_UNIQUE` (`dphone`),
  UNIQUE KEY `demail_UNIQUE` (`demail`)
...
-- Dump completed on 2022-01-11 10:23:38
